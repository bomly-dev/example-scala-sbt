...
> Find vulnerabilities, trace reachability, and audit open-source risk in your **Scala** project.

## About

This repository is a [Bomly](https://bomly.dev) example project for **Scala** with **sbt**.
...
```bash
bomly scan --url https://github.com/bomly-dev/example-scala-sbt --ecosystems scala
```
...
```bash
bomly scan --url https://github.com/bomly-dev/example-scala-sbt --ecosystems scala --enrich --audit
```

### 3. Trace why a dependency exists

Understand every path that pulls `org.mindrot:jbcrypt` into your graph:
